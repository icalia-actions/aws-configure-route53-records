...
ARG APP_PATH=/icalia-actions/aws-configure-route53-records
...
ARG APP_PATH=/icalia-actions/aws-configure-route53-records
COPY --from=builder --chown=node:node ${APP_PATH} /icalia-actions/aws-configure-route53-records
WORKDIR /icalia-actions/aws-configure-route53-records
